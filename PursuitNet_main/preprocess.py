...
def main():
    ...
    train_dataset = PECCSVDataset(
        args.train_split, args.train_split_pre, args)
    val_dataset = PECCSVDataset(args.val_split, args.val_split_pre, args)
    test_dataset = PECCSVDataset(args.test_split, args.test_split_pre, args)
